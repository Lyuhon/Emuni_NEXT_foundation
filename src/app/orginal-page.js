...
export default function PreFoundationPage() {
    ...
    return (
        <div className="min-h-screen bg-white overflow-hidden">
            ...
            {/* Hero Section */}
            <section id="hero-" className="hidden relative overflow-hidden bg-gradient-to-br from-[#920259] via-[#7a004a] to-[#5a0038] pt-20 md:pt-32 pb-24">
                                ...
                                <div className="flex items-center gap-3 sm:gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-1 text-sm sm:text-base md:text-lg font-extrabold text-[#3b0022] leading-tight">
                                            2024 yilning
                                            <span className="block text-base sm:text-lg md:text-xl text-[#7a003f]">eng yaxshi xususiy universiteti</span>
                                        </div>
                                    </div>
                                </div>
      ...
      `}</style>
                    ...
                    <div className="grid grid-cols-1 gap-12 items-center">
                        <div className="space-y-6 pt-24 sm:pt-24 md:pt-12">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 md:mb-32 mb-10">
                                ...
                                <div className="hidden sm:flex z-30">
            ...
            {/* Contact Section */}
            <section id="contact" className="hidden max-w-7xl mx-auto px-6 py-24">
